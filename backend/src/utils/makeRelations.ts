...
interface PossibleRelations {
    [key: string]: PossibleRelations;
}

function parseSelectionSet(
    set: SelectionSetNode,
    levelPossibleRelations: PossibleRelations
) {
